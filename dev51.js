          ...
          $('a.dropdown-link').click(function() {
                ...
                if (prop.distance) {
                   ...
                   if (roundedDistance < 100) {
                     ...
                     details.innerHTML +=
                            '<div class="p-hide"><span class="p-email">' + prop.email + '</span><span class="p-lang">' + prop.language + '</span><span class="p-area">' + prop.area + '</span><span class="p-profi">' + prop.profile + '</span><span class="p-twitter">' + prop.twitter + '</span><span class="p-facebook">' + prop.facebook + '</span><span class="p-linkedin">' + prop.linkedin + '</span></div>';
                   }
